...
//透视变换后图像行列数
#define         TRFED_ROW               120
#define         TRFED_COL               188
...
#define ImageUsed a//  *PerImg_ip//*PerImg_ip//SimBinImage//定义使用的图像，ImageUsed为用于巡线和识别的图像，在cam.c中使用
extern uint8_t a[ROW][COL];
...
#define AT_IMAGE(img,x,y) (ImageUsed[ROW-(y)][x])
#define AT  AT_IMAGE
