...
typedef struct{
    ...
    int left_cnt_deal;
    int right_cnt_deal;
    int16 Left_line[k*ROW][2];
    int16 Right_line[k*ROW][2];
    float Left_line_itcm[k*ROW][2];
    float Right_line_itcm[k*ROW][2];


    int16 left_deal_line[k*ROW][2];
    int16 right_deal_line[k*ROW][2];
...
#define sample_dist  0.02
#define angle_dist  0.2
